...
urlpatterns = [
    ...
    path('api/revenue-breakdown/', views.api_revenue_breakdown, name='api_revenue_breakdown'),
    ...
    path('api/cash-bank-receipt/bulk-upload/template/', views.api_cash_bank_receipt_bulk_template, name='api_cash_bank_receipt_bulk_template'),
    path('api/cash-bank-receipt/bulk-upload/', views.api_cash_bank_receipt_bulk_upload, name='api_cash_bank_receipt_bulk_upload'),
    ...
    path('api/cash-received-transactions/export/', views.export_cash_received_transactions, name='export_cash_received_transactions'),
    path('api/cash-bank-receipt/<int:entry_id>/update/', views.api_cash_bank_receipt_update, name='api_cash_bank_receipt_update'),
    path('api/cash-bank-receipt/<int:entry_id>/delete/', views.api_cash_bank_receipt_delete, name='api_cash_bank_receipt_delete'),
    ...
    path('api/agent-commission-payment/<int:entry_id>/delete/', views.api_agent_commission_payment_delete, name='api_agent_commission_payment_delete'),
    ...
    path('api/revenue-adjustment/<int:entry_id>/update/', views.api_revenue_adjustment_update, name='api_revenue_adjustment_update'),
    path('api/revenue-adjustment/<int:entry_id>/delete/', views.api_revenue_adjustment_delete, name='api_revenue_adjustment_delete'),
    path('api/revenue-adjustment/bulk-upload/template/', views.api_revenue_adjustment_bulk_template, name='api_revenue_adjustment_bulk_template'),
    path('api/revenue-adjustment/bulk-upload/', views.api_revenue_adjustment_bulk_upload, name='api_revenue_adjustment_bulk_upload'),
