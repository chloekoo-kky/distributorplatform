...
urlpatterns = [
    ...
    path('api/bulk-delete-images/', views.ajax_bulk_delete_images, name='ajax_bulk_delete_images'),
    ...
    path('api/bulk-auto-assign/', views.ajax_bulk_auto_assign, name='ajax_bulk_auto_assign'),
